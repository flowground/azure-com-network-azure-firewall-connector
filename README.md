...
Generated from: https://api.apis.guru/v2/specs/azure.com/network-azureFirewall/2018-12-01/swagger.json<br/>
...
#### Input Parameters
* `resourceGroupName` - _required_ - The name of the resource group.
* `azureFirewallName` - _required_ - The name of the Azure Firewall.
* `api-version` - _required_ - Client API version.
* `subscriptionId` - _required_ - The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
...
**flow**ground :- Telekom iPaaS / azure-com-network-azure-firewall-connector<br/>
